...
lyr_KETERANGANKERUSAKANSALURAN_7.set('fieldAliases', {'Id': 'Id', 'OBJECTID': 'OBJECTID', 'JENIS': 'JENIS', 'KATEGORI': 'KATEGORI', 'KETERANGAN': 'KETERANGAN', 'PANJANG': 'PANJANG', 'JNS': 'JNS', });
lyr_JENISSALURAN_8.set('fieldAliases', {'Id': 'Id', 'OBJECTID': 'OBJECTID', 'JENIS': 'JENIS', 'PANJANG': 'PANJANG', });
...
lyr_KETERANGANKERUSAKANSALURAN_7.set('fieldImages', {'Id': 'Range', 'OBJECTID': 'TextEdit', 'JENIS': 'TextEdit', 'KATEGORI': 'TextEdit', 'KETERANGAN': 'TextEdit', 'PANJANG': 'TextEdit', 'JNS': '', });
lyr_JENISSALURAN_8.set('fieldImages', {'Id': 'Range', 'OBJECTID': 'TextEdit', 'JENIS': 'TextEdit', 'PANJANG': 'TextEdit', });
...
lyr_KETERANGANKERUSAKANSALURAN_7.set('fieldLabels', {'Id': 'hidden field', 'OBJECTID': 'hidden field', 'JENIS': 'hidden field', 'KATEGORI': 'inline label - visible with data', 'KETERANGAN': 'inline label - visible with data', 'PANJANG': 'inline label - visible with data', 'JNS': 'no label', });
lyr_JENISSALURAN_8.set('fieldLabels', {'Id': 'hidden field', 'OBJECTID': 'hidden field', 'JENIS': 'inline label - visible with data', 'PANJANG': 'inline label - visible with data', });
